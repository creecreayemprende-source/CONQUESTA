    ...
    <div className="flex min-h-dvh flex-col px-4 pt-4">
      ...
      <div className="mt-4 flex flex-col gap-2.5">
        {TEMAS_SOPA_LETRAS.map((t) => (
          <Link
            key={t.pais}
            href={`/app/retos/sopa-letras/${encodeURIComponent(t.pais)}`}
          ...
          >
            ...
            <div className="flex-1">
              <p className="font-display text-sm font-bold text-txt-primary">{t.pais}</p>
              <p className="text-xs text-txt-tertiary">10 palabras para descubrir</p>
            </div>
          </Link>
        ))}
      </div>
